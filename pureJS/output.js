const Output = {
    ...
    SaveCode: (inFile, file, src, basic, model) => {
        ...
        // Scrivi il risultato nella textarea o in un div
        document.getElementById('outputASM').value = out;

        // Genera system labels basate sul modello
        ...
        // Scrivi anche le system labels nella textarea
        document.getElementById('outputASM').value += "\n\n" + sysLabelsOut;
    }
};
